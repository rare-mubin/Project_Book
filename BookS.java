...
public class BookS extends JFrame implements ActionListener
{
	...
	public BookS(String userName)
	{
		...
		l2 = new JLabel("");
		l2.setFont(new Font("Felix Titling",Font.BOLD,36));
		l2.setForeground(Color.black);
		l2.setBounds(54,56,246,45);
		l1.add(l2);

		l3 = new JLabel("");
		l3.setFont(new Font("Felix Titling",Font.BOLD,36));
		l3.setForeground(Color.black);
		l3.setBounds(54,128,246,45);
		l1.add(l3);

		l4 = new JLabel("");
		l4.setFont(new Font("Felix Titling",Font.BOLD,36));
		l4.setForeground(Color.black);
		l4.setBounds(54,200,246,45);
		l1.add(l4);

		l5 = new JLabel("");
		l5.setFont(new Font("Felix Titling",Font.BOLD,36));
		l5.setForeground(Color.black);
		l5.setBounds(54,272,246,45);
		l1.add(l5);

		l7 = new JLabel("");
		l7.setFont(new Font("Felix Titling",Font.BOLD,36));
		l7.setForeground(Color.black);
		l7.setBounds(377,55,169,279);
		l1.add(l7);

		l8 = new JLabel("");
		l8.setFont(new Font("Felix Titling",Font.BOLD,36));
		l8.setForeground(Color.black);
		l8.setBounds(588,55,169,279);
		l1.add(l8);

		l9 = new JLabel("");
		l9.setFont(new Font("Felix Titling",Font.BOLD,36));
		l9.setForeground(Color.black);
		l9.setBounds(799,55,169,279);
		l1.add(l9);

		l10 = new JLabel("");
		l10.setFont(new Font("Felix Titling",Font.BOLD,36));
		...
		l12 = new JLabel("");
		l12.setFont(new Font("Felix Titling",Font.BOLD,36));
		l12.setForeground(Color.black);
		l12.setBounds(588,386,169,279);
		l1.add(l12);

		l13 = new JLabel("");
		l13.setFont(new Font("Felix Titling",Font.BOLD,36));
		l13.setForeground(Color.black);
		l13.setBounds(799,386,169,279);
		l1.add(l13);

		l14 = new JLabel("");
		l14.setFont(new Font("Felix Titling",Font.BOLD,36));
